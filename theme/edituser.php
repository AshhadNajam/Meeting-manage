...
<body>
    ...
    <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        <div class="nano">
            ...
            <div class="logo">
            <a href="index.html">
            <img class="img-fluid" id="logo-image" src="images/logo.png" alt="" />
            </a>
            </div>
                <ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="float-left">
                        ...
                        <div id="hide-logo-button" class="hamburger sidebar-toggle">
                ...
                <section id="main-content">
                    <form  method="post">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"  value="<?php echo "$name"?>"  name="name" aria-describedby="name">
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" value="<?php echo "$contact"?>"  name="contact" aria-describedby="contact">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputEmail1" class="form-label">Designation</label>
                                                            <input type="text" class="form-control"  value="<?php echo "$designation"?>"  name="designation" aria-describedby="emailHelp">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputEmail1" class="form-label">Department</label>
                                                            <input type="text" class="form-control"  value="<?php echo "$department"?>"  name="department" aria-describedby="emailHelp" >
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputEmail1" class="form-label">Region</label>
                                                            <input type="text" class="form-control" value="<?php echo "$region"?>" name="region" aria-describedby="emailHelp">
                                                        </div>
                                                        <button type="submit" class="btn" name="btned">Submit</button>
                                                    </form>
                </section>
            </div>
        </div>
...
if(isset($_POST['btned'])){
    ...
    $region=$_POST['region'];
    $que="UPDATE user_tb SET name='$name', email='$email', contact='$contact', designation='$designation', department='$department', region='$region' WHERE name='$name'";
