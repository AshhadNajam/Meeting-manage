                ...
                <div class="nano-content">
                    <div class="logo">
                        ...
                        <li><a href="app-email.html"><i class="ti-email"></i> Email</a></li>
                          </li><li><a href="app-profile.html"><i class="ti-user"></i> Profile</a></li>
                          <li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 p-l-0 title-margin-left">
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><button type="button"  class="btn  btn-md m-b-10 m-l-5" data-bs-toggle="modal" data-bs-target="#myModal">Create new user</button></li>
                                    <!-- Bootstrap Modal -->
                                                ...
                                                <div class="modal-body">
                                                    <form  method="post">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"  name="contact" aria-describedby="contact">
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"  name="department" aria-describedby="emailHelp" >
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputEmail1" class="form-label">Region</label>
                                                            <input type="text" class="form-control" name="region" aria-describedby="emailHelp">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputEmail1" class="form-label">File uploader</label>
                                            ...
                                            <?php
                                                    ...
                                                    while ($key = mysqli_fetch_assoc($re)) {
                                                        echo '<tr>
                                                            ...
                                                            <td>' . $key['region'] . '</td>
                                                            <td><a href="deleteuser.php?n='.$key['name'].'">
                                                            <i class="ti-trash"></i> </a><a href="edituser.php?n='.$key['name'].'&e='.$key['email'].'&c='.$key['contact'].'&d='.$key['designation'].'&de='.$key['department'].'&r='.$key['region'].'">
                                                            <i class="ti-pencil-alt"></i>  </a><a href="profile.php?n='.$key['name'].'&e='.$key['email'].'&c='.$key['contact'].'&d='.$key['designation'].'&de='.$key['department'].'&r='.$key['region'].'&f='.$key['img'].'">
...
if(isset($_POST['btnint'])){
    ...
    $que="INSERT INTO user_tb(name,email,contact,designation,department,region,img) VALUES('".$_POST['name']."','".$_POST['email']."','".$_POST['contact']."','".$_POST['designation']."','".$_POST['department']."','".$_POST['region']."','$folder')";
